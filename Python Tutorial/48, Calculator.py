...
label = Label(window, textvariable=equation_label, font=('consolas',20), bg='black',fg='#00ffff', width=24, height=2)
label.pack()
...
plus = Button(frame, text='+', height=4, width=9, font=35, bg='black', fg='#00ff00',
                 command=lambda: button_press('+'))
plus.grid(row=0,column=3)

minus = Button(frame, text='-', height=4, width=9, font=35, bg='black', fg='#00ff00',
                 command=lambda: button_press('-'))
minus.grid(row=1,column=3)

multiply = Button(frame, text='x', height=4, width=9, font=35, bg='black', fg='#00ff00',
                 command=lambda: button_press('*'))
multiply.grid(row=2,column=3)

divide = Button(frame, text='/', height=4, width=9, font=35, bg='black', fg='#00ff00',
                 command=lambda: button_press('/'))
divide.grid(row=3,column=3)

equal = Button(frame, text='=', height=4, width=9, font=35, bg='black', fg='yellow',
                 command=equals)
...
clear = Button(window, text='C', height=4, width=15, font=35,bg='black', fg='red',
                 command=clear)
clear.pack()
